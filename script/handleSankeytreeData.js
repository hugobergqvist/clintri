...
const megaFetch = (
  ...
  let megaUrl = `https://clinicaltrials.gov/api/query/study_fields?expr=${condition}&fields=BriefTitle%2CStudyType%2CPhase%2CNCTId%2CGender%2CLocationCountry%2CStdAge%2CBriefSummary%2CMinimumAge%2CMaximumAge%2CStartDate&min_rnk=${min}&max_rnk=${max}&fmt=json`;
  fetch(megaUrl)
